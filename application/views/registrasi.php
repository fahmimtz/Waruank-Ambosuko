          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" id="exampleInputEmail" placeholder="Nomor Telepon Anda" name="no_telepon">
                  <?php echo form_error('no_telepon', '<div class="text-danger small ml-2">', '</div>') ?>
                </div>
